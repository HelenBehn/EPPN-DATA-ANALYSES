...
comp_2XY4 <- comp_2XY4 %>%
  ...
  Genotype == "N5C2J1_PH22" ~ "NCJ allohexaploid hybrids",
  Genotype == "N5C2J1_PH42" ~ "NCJ allohexaploid hybrids",
  Genotype == "N5C2J2_PH23" ~ "NCJ allohexaploid hybrids",
  Genotype == "N6C2J2_PH24" ~ "NCJ allohexaploid hybrids",
  Genotype == "N1C1J1_PH25" ~ "NCJ allohexaploid hybrids",
  Genotype == "N1C2J1_PH26" ~ "NCJ allohexaploid hybrids",
  Genotype == "N4C2J1_PH27" ~ "NCJ allohexaploid hybrids",
  Genotype == "N5C2J2_PH30" ~ "NCJ allohexaploid hybrids",
  Genotype == "N1C1J1_PH31" ~ "NCJ allohexaploid hybrids",
  Genotype == "N6C2J2_PH35" ~ "NCJ allohexaploid hybrids",
  Genotype == "N1C1J1_PH36" ~ "NCJ allohexaploid hybrids",
  Genotype == "N1C1J1_PH39" ~ "NCJ allohexaploid hybrids",
  Genotype == "N1C2J1_PH40" ~ "NCJ allohexaploid hybrids",
  Genotype == "N6C2J2_PH44" ~ "NCJ allohexaploid hybrids",
  Genotype == "N4C2J1_PH45" ~ "NCJ allohexaploid hybrids",
  Genotype == "N6C2J2_PH48" ~ "NCJ allohexaploid hybrids",
  Genotype == "N7C1J1" ~ "NCJ allohexaploid hybrids",
...
anova <- aov(first_flowers_DAS ~ Genotype, data = comp_2XY4)
summary(anova)
...
comp_2XY4ord$Genotype <- factor(comp_2XY4ord$Genotype,     
                                levels = c("N1C1J1.N5C2J2", "N1C1J1. N6C2J2", 
...
#boxplot first_flowers_DAS 2XY4
ggplot(comp_2XY4ord, aes(Genotype, first_flowers_DAS, fill = Type, color = Type)) + 
  geom_boxplot() +
  ...
  scale_fill_viridis(discrete = TRUE, option = "D", direction = 1, alpha = 0.5,
                     breaks=c("B. oleracea (P1)", "B. juncea (P2)", 
                              ...
                              "OJ allohexaploid hybrids", "NCJ allohexaploid hybrids", "F1 allohexaploid hybrids"),
                     labels=c("B. oleracea (P1)", "B. juncea (P2)", 
                              "B. napus (P1)", "B. carinata (P2)", "B. juncea (P3)", 
                              "OJ allohexaploid hybrids", "NCJ allohexaploid hybrids", "F1 allohexaploid hybrids")) ##reorder legend labels!
