# Comparison 3X: plant_height in JC hybrids
#load packages 
...
anova <- aov(plant_height ~ Genotype, data = comp_3X)
summary(anova)
...
#ohne facet_wrap ###############
#boxplot ## plant_height ###
ggplot(comp_3Xord, aes(Genotype, plant_height, fill = Generation, color = Generation)) + 
  geom_boxplot() +
