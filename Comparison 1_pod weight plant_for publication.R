# Comparison 1X: pod_weight_plant in Resynth. B.napus
...
anova <- aov(pod_weight_plant ~ Genotype, data = comp_1X)
summary(anova)
...
#boxplot ## pod_weight_plant ###
ggplot(comp_1X, aes(Genotype, pod_weight_plant, fill = Generation, color = Generation)) + 
  geom_boxplot() +
