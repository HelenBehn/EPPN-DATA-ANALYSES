# Comparison 3X: pod_weight_plant in JC hybrids
#load packages 
...
anova <- aov(pod_weight_plant ~ Genotype, data = comp_3X)
summary(anova)
...
#ohne facet_wrap ###############
#boxplot ## pod_weight_plant ###
ggplot(comp_3Xord, aes(Genotype, pod_weight_plant, fill = Generation, color = Generation)) + 
  geom_boxplot() +
