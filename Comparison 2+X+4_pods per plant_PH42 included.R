...
comp_2X4 <- DATA[DATA$Genotype %in% c("N5", "N6", "N1", "N4", "N7","C1", "C2", "J1", "J2", 
...
anova <- aov(pods_plant ~ Genotype, data = comp_2X4)
summary(anova)
...
Tk <- group_by(comp_2X4, Genotype) %>%
  summarise(mean = round(mean(pods_plant, na.rm = TRUE), digits = 1), quant = round(quantile(pods_plant, probs = 0.75, na.rm = TRUE), digits = 1)) %>%
...
comp_2X4ord$Genotype <- factor(comp_2X4ord$Genotype,     
                                levels = c("N1C1J1.N1C2J1", "N1C1J1.N5C2J2", "N1C1J1. N6C2J2", 
                                           ...
                                           "N6C2J2_PH24", "N6C2J2_PH35", "N6C2J2_PH44", "N6C2J2_PH48", 
                                           "N5C2J1_PH22", "N5C2J1_PH42",
                                           "N5C2J2_PH30", "N5C2J2_PH23", 
                                           "N7C1J1",
                                           
                                           "J1", "J2", "C1", "C2", "N1", "N4", "N5", "N6", "N7"))

ANOVA_Tukey_2X4ord <- ANOVA_Tukey_2X4
ANOVA_Tukey_2X4ord$Genotype <- factor(ANOVA_Tukey_2X4ord$Genotype,     
                                  levels = c("N1C1J1.N1C2J1", "N1C1J1.N5C2J2", "N1C1J1. N6C2J2", 
                                             "N5C2J2.N7C1J1", "N5C2J2.N6C2J2", "N5C2J2.N5C2J2", 
                                             "N6C2J2.N4C2J1", "N6C2J2.N7C1J1", "N6C2J2.O1J3",
...
#boxplot pods_plant 2X4
ggplot(comp_2X4ord, aes(Genotype, pods_plant, fill = Line, color = Line)) + 
  geom_boxplot() +
  labs(x="Genotype", y="Number of pods/plant") +
  ...
  scale_fill_viridis(discrete = TRUE, option = "D", direction = 1, alpha = 0.5,
                     breaks=c("P1", "P2", "P3", "novel allohexaploid", "allohexaploid hybrid"),
                     labels=c("P1", "P2", "P3", "novel allohexaploid", "allohexaploid hybrid")) ##reorder legend labels!
