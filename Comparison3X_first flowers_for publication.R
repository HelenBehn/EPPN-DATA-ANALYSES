# Comparison 3X: first_flowers_DAS in JC hybrids
#load packages 
...
anova <- aov(first_flowers_DAS ~ Genotype, data = comp_3X)
summary(anova)
...
#ohne facet_wrap ###############
#boxplot ## first_flowers_DAS ###
ggplot(comp_3Xord, aes(Genotype, first_flowers_DAS, fill = Generation, color = Generation)) + 
  geom_boxplot() +
