# Comparison 1X: first_flowers_DAS in Resynth. B.napus
...
anova <- aov(first_flowers_DAS ~ Genotype, data = comp_1X)
summary(anova)
...
#boxplot ## first_flowers_DAS ###
ggplot(comp_1X, aes(Genotype, first_flowers_DAS, fill = Generation, color = Generation)) + 
  geom_boxplot() +
