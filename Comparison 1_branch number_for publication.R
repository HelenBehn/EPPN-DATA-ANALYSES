# Comparison 1X: branch_number in Resynth. B.napus
...
anova <- aov(branch_number ~ Genotype, data = comp_1X)
summary(anova)
...
ggplot(comp_1X, aes(Genotype, branch_number, fill = Generation, color = Generation)) + 
  geom_boxplot() +
